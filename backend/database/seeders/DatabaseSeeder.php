    ...
    public function run(): void
    {
        ...
        // Users
         ...
         $users = [
            ...
            ['name' => 'Kaspars88',    'email' => 'kaspars@example.com', 'password' => 'password', 'role' => 'user', 'bio' => 'Man ļoti patīk lomu spēles, un dažreiz es spēlēju stratēģijas spēles', 'avatar' => 'https://i.pinimg.com/736x/47/e2/c1/47e2c13c533c5d1e87c98cf6fdd83ff1.jpg', 'isPrivate' => false],
            ['name' => 'LaimaGamer',   'email' => 'laima@example.com', 'password' => 'password', 'role' => 'user', 'bio' => 'Indie spēles ir labākās lietas, ko cilvēki jebkad ir izdomājuši', 'avatar' => null, 'isPrivate' => false],
            ...
            ['name' => 'Zane_plays',   'email' => 'zane@example.com', 'password' => 'password', 'role' => 'user', 'bio' => 'Es neesmu ikdienas spēlētājs, es spēlēju tikai Souls spēles', 'avatar' => null, 'isPrivate' => false],
            ...
            ['name' => 'DianaRPG',     'email' => 'diana@example.com', 'password' => 'password', 'role' => 'user', 'bio' => 'profesionāls kļūdu detektīvs visās spēlēs', 'avatar' => 'https://i.pinimg.com/736x/d7/d2/23/d7d223976fc5d8e02a0584ff8dcb11d1.jpg', 'isPrivate' => false],
            ['name' => 'TomsMetal',    'email' => 'toms@example.com', 'password' => 'password', 'role' => 'user', 'bio' => 'Es ienīstu bailes, bet es spēlēju šausmu spēles', 'avatar' => 'https://i.pinimg.com/736x/0d/4a/2d/0d4a2d3b6add65506932c2429935c074.jpg', 'isPrivate' => true],
            ['name' => 'SandraQuest',  'email' => 'sandra@example.com', 'password' => 'password', 'role' => 'user', 'bio' => '4000 stundas “norādi un klikšķini” spēļu un vizuālo romānu', 'avatar' => null, 'isPrivate' => false],
